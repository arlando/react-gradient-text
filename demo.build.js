...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GradientText = __webpack_require__(159);
	...
	var rainbow = (0, _index2.default)('#0071bc', '#662d91', '#e5005d', 10).toArray('rgbString');
	var rainbow2 = (0, _index2.default)('#ff0000', '#00FF04', 20).toArray('rgbString');
	var rainbow3 = (0, _index2.default)('#f5f5f5', '#edc613', 20).toArray('rgbString');

	var Simple = function Simple() {
	    return _react2.default.createElement(_GradientText.GradientText, { data: 'today will be a really good day', gradient: rainbow3, animating: false });
	};

	var Header = function Header() {
	    return _react2.default.createElement(_GradientText.GradientText, { data: 'React Gradient Text', gradient: rainbow });
	};

	var Opacity = function Opacity() {
	    return _react2.default.createElement(_GradientText.GradientText, { data: 'Change the opacity', gradient: [], opacity: 50 });
	};

	var SlowItDown = function SlowItDown() {
	    return _react2.default.createElement(_GradientText.GradientText, { data: 'Slow it all down...', gradient: rainbow, interval: 250 });
	};

	var Hoverable = function Hoverable() {
	    return _react2.default.createElement(_GradientText.GradientText, { data: 'On Hover', gradient: rainbow2, hoverable: true });
	};

	var TwoColors = function TwoColors() {
	    return _react2.default.createElement(_GradientText.GradientText, { data: 'Two Colors', gradient: ['E50003', '007AE5'], hoverable: true });
	};
	...
	var OnEvent = function OnEvent() {
	    ...
	    return _react2.default.createElement(_GradientText.GradientText, { data: 'On Event', gradient: rainbow3, onEvent: evt });
	};
	...
	var GradientText = function (_React$Component) {
	    ...
	    _createClass(GradientText, [{
	        ...
	        value: function shouldComponentUpdate(nextProps) {
	            ...
	            if (nextProps.hoverable && this.state.hover === false) return false;
	            return true;
	        }

	        // todo listen for timer change
...
/***/ function(module, exports, __webpack_require__) {
	...
	var conversions = __webpack_require__(164);
